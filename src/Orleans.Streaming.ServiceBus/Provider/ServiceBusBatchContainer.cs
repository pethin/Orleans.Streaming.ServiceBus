...
namespace Orleans.Streaming.ServiceBus.Provider
{
    ...
    {
        [NonSerialized] internal ServiceBusReceivedMessage? ServiceBusReceivedMessage;

        private readonly Dictionary<string, object>? _requestContext;
        protected List<object> Events { get; set; }

        public ServiceBusBatchContainer(Guid streamGuid, string streamNamespace, List<object> events,
